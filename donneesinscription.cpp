...
DonneesInscription::DonneesInscription(std::string *mail,std::string *mot_de_passe,std::string *nom,std::string *prenom,std::string *telephone,std::string *adresse) : VerificationDonnees(mail, mot_de_passe)
{
    this->nom=nom;
    this->prenom = prenom;
